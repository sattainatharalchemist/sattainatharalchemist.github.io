(function ($) {
  ...
  //toggle images in slider_bg_1 class 
  function switchImage() {
    var img = ['../img/banner/siddha.jpeg', '../img/banner/bg1.jpg', '../img/banner/bg2.jpg', '../img/banner/bg3.jpg', '../img/banner/bg4.jpg', '../img/banner/bg5.jpg']
    var counter = 0;
